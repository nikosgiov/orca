class AppStrings {
  ...
  static const String invalidIpPort =
      'Please enter a valid IP:PORT (e.g. 192.168.1.10:2375)';
  ...
  static const String createFirstContainer =
  ...
  static const String connectToDocker =
      'Connect to Docker daemon to view resource monitoring';
  ...
  static const String connectionLostDesc =
      'The connection to the Docker daemon has been lost.';
  ...
  static const String errorLoadingContainerData =
  ...
  static const String saveHostCredentials =
      'Save host and credentials for automatic login';
  static const String hostUriAlwaysSaved =
      'The host URI will always be saved for convenience, even if credentials are not saved.';
  ...
  static const String stayLoggedInSubtitle =
      'Remain logged in on this device. If unchecked, you will be logged out when you close the app.';
  static const String autoLogoutMessage =
      'Connection failed multiple times. Please re-enter your Docker host details.';
